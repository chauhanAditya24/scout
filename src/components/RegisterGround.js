...
const RegisterGround = (props) => {
    ...
    }, [dispatch, isRegister,props.history])
    ...
    return (
        <div style={{ marginTop: '20px', marginBottom: '20px' }} className='ground-register'>
            ...
            {isRegister && (
                <div className="toast show position-fixed bottom-0 end-0 p-2 m-4 toast-available" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="toast-header">
                        <strong className="me-auto">Successfully booked</strong>
                        <button type="button" className="btn-close" ></button>
                    </div>
                </div>
            )}

            <h1 style={{ marginLeft: '100px' }}>Register ground</h1>
